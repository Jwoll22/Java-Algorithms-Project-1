...
public class DictTest
{
	public static void main(String [] args) throws IOException
	{
		...
		while (fileScan.hasNext())
		{
			...
			D.add(st);
			//D.searchPrefix(new StringBuilder("abc"), 3);
		}
		...
		for (int i = 0; i < tests.length; i++)
		{
			...
			int ans = D.searchPrefix(sb, tests[i].length());
			System.out.print(sb + " is ");
			switch (ans)
			{
				case 0: System.out.println("not found");
					break;
				case 3: System.out.println("a prefix");
					break;
				case 1: System.out.println("a word");
					break;
				case 2: System.out.println("a word and prefix");
			}
		}
	}
}
